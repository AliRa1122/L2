...
**Testing**
The project includes unit tests for the ViewModels and Repositories. To run the tests:

    1. In Android Studio, right-click on the app/src/test directory.
    2. Select "Run Tests in 'app'" from the context menu.
